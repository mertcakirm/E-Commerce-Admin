      ...
      <div>
        <div className="admin-sidebar-parent">
          <div className='admin-sidebar-logo-part'>
            ...
            <a className='admin-sidebar-link' href="/kullanicilar">
              <div className="links-row align-items-center">
            ...
            <a className='admin-sidebar-link' href="/kampanyalar">
              <div className="links-row align-items-center">
            ...
            <a className='admin-sidebar-link' href="/sayfalar">
              <div className="links-row align-items-center">
            ...
            <a className='admin-sidebar-link' href="/raporlar">
              <div className="links-row align-items-center">
            ...
            <a className='admin-sidebar-link' href="/mesajlar">
              <div className="links-row align-items-center">
          ...
          <svg fill='white' xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><path d="M16 10v-5l8 7-8 7v-5h-8v-4h8zm-16-8v20h14v-2h-12v-16h12v-2h-14z"/></svg><span>Çıkış Yap</span>
          </button>
        </div>
      </div>
    )
