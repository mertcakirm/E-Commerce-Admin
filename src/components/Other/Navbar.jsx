                ...
                <div className="d-flex  w-100 justify-content-between">
                    ...
                    <div className="d-flex align-items-center gap-4  justify-content-end">
                        ...
                        <a className="nav-top-btn" href="/mesajlar">
                            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" fillRule="evenodd" clipRule="evenodd"><path d="M24 21h-24v-18h24v18zm-23-16.477v15.477h22v-15.477l-10.999 10-11.001-10zm21.089-.523h-20.176l10.088 9.171 10.088-9.171z"/></svg>
                        </a>
                ...
                <div className='admin-sidebar-links'>
                    <Link className={`admin-sidebar-link ${url === "ana-panel" ? "active-link" : ""}`} to="/ana-panel">
                        <div className="links-row align-items-center">
                            ...
                            <svg clipRule="evenodd" fill="white" width="30" height="30" fillRule="evenodd"
                    ...
                    <Link className={`admin-sidebar-link ${url === "urunler" ? "active-link" : ""}`} to="/urunler">
                        <div className="links-row align-items-center">
                            ...
                            <svg width="30" height="30" viewBox="0 0 27 27" fill="white"
                                 xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
                                <path
                    ...
                    <Link className={`admin-sidebar-link ${url === "kategoriler" ? "active-link" : ""}`}
                        ...
                        <div className="links-row align-items-center">
                            ...
                            <svg width="30" height="30" fill="white" viewBox="0 0 24 24" clipRule="evenodd"
                    ...
                    <Link className={`admin-sidebar-link ${url === "kampanyalar" ? "active-link" : ""}`}
                        ...
                        <div className="links-row align-items-center">
                            ...
                            <svg width="30" height="30" fill="white" viewBox="0 0 27 27"
                                 xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
                                <path
                    ...
                    <Link className={`admin-sidebar-link ${url === "sayfalar" ? "active-link" : ""}`} to="/sayfalar">
                        <div className="links-row align-items-center">
                            ...
                            <svg clipRule="evenodd" fillRule="evenodd" width="30" height="30" fill="white"
