                        ...
                        <div className="row">
                            <div className="col-12 row mb-5" style={{rowGap: '30px', height: 'fit-content'}}>
                                ...
                                <div className="col-6 row justify-content-end">
                                    <button onClick={togglePopup} className='tumunu-gor-btn-admin col-4'>Kampanya Ekle
                                    </button>
                                </div>
                            </div>
                                        ...
                                        <td style={{position: 'relative'}}>
                                            <div style={{position: 'absolute', top: '0', left: '0'}}
                                                ...
                                                <button className="answer-message-btn w-75"
                                                        onClick={toggleProcessPopup}>Sil
                                                </button>
                                            </div>
                                        </td>
                                    </tr>
