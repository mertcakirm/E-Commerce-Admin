                                ...
                                <table className="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td style={{position:'relative'}}>
                                            <div style={{position:'absolute',top:'0',left:'0'}} className="row w-100 h-100 p-0 m-0 align-items-center justify-content-center" >
                                                <button className="answer-message-btn w-75"  onClick={toggleProcessPopup}>Sil</button>
                                            </div>
                                        </td>
                                    </tr>
