      ...
      <div>
        <Admin_sidebar />
          <div className="admin-sag-container">
            <div className="col-12 alt-basliklar-admin">Kampanyalar</div>
                <div className="row admin-genel-row">       
                    <div className="col-12">
                        <div className="site-icerik-shadow2 row">
                            <div className="col-6 row" style={{rowGap:'30px',height:'fit-content'}}>
                                <div className="col-12 alt-basliklar-admin">Kampanya Ekle</div>

                                <div className="row col-12">
                                    <label htmlFor="kampanya-resim-inp" className="col-5">Kampanya Resmi</label>
                                    <input type="file" id='kampanya-resim-inp' className="col-7" />
                                </div>
                                <div className="row col-12">
                                    <label htmlFor="kampanya-baslik-inp" className="col-5">Kampanya Başlığı</label> 
                                    <input type="text" id='kampanya-baslik-inp' className="col-7" />
                                </div>
                                <div className="row col-12">
                                ...
                                <table className="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td style={{display:'flex',alignItems:'center'}}>
                                            <button className="w-100">Sil</button>
                                        </td>
                                    </tr>
