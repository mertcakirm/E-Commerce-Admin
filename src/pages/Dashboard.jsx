                    ...
                    <div className="col-lg-6 col-12 d-flex flex-wrap">
                        <div className="col-lg-6 justify-content-center col-12 m-0 row">
                            <div className="tooltip-container">
                                <div
                                    className="d-flex flex-column align-items-center justify-content-center site-icerik-shadow"
                                    style={{height: '200px'}}>
                                    <svg
                                        className="col-12"
                        ...
                        <div className="col-lg-6 justify-content-center col-12 m-0 row">
                            <div className="tooltip-container">
                                <div className="d-flex flex-column align-items-center site-icerik-shadow pt-4"
                                     style={{height: '200px'}}>
                        ...
                        <div className="col-lg-6 justify-content-center col-12 m-0 row">
                            <div className="tooltip-container">
                                <div
                                    className="d-flex flex-column site-icerik-shadow align-items-center justify-content-center"
                                    style={{height: '200px'}}>
                                    <svg
                                        fill="green"
                                        width="70"
                            ...
                            <div className="table-responsive scroll-table2 mt-1">
                                <table className="table text-center  table-striped">
                                    ...
                                    {lowStockProducts.map(product => (
                                        <tr onClick={() => GoProduct(product.id)} style={{cursor: 'pointer'}}
                                            key={product.id}>
